  ...
  this.async = function () {
    return function (err, content) {
      ...
      if (!query.namedExport) {
        cssModuleDefinition = (0, _cssModuleToInterface.generateGenericExportInterface)(cssModuleKeys, filename, '  ', query.noSemicolons);
      } else {
        ...
        cssModuleDefinition = (0, _cssModuleToInterface.generateNamedExports)(nonReservedWordDefinitions, query.noSemicolons);
      }
